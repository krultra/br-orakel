...
export const mockObligations: Obligation[] = [
  {
    id: 'obl-a-melding', name: 'A-meldingen', description: 'Rapportering av lønns- og ansettelsesforhold til Skatteetaten, NAV og SSB.', conceptLinks: [{ label: 'lønns', query: 'lønn' }], detailInfo: { targetAudience: 'Arbeidsgivere og andre som skal levere ansatt- og inntektsopplysninger via en systemløsning.', usageContexts: ['Periodisk rapportering'], usageNotes: ['A-meldingen leveres hver måned og inneholder opplysninger om inntekt, arbeidsforhold, forskuddstrekk og arbeidsgiveravgift.'], dataSources: ['Lønnsstatistikk', 'NAV AA-register', 'Enhetsregisteret'] }, officialStatus: 'OFFICIAL', responsibleAgency: 'Skatteetaten', legalBasis: 'A-opplysningsloven', targetCriteria: ['AS', 'arbeidsgiveransvar'], reportingWindowStart: '2026-09-01', reportingWindowEnd: '2026-09-05', deadline: '2026-09-05', deadlineDates: ['2026-01-05', '2026-02-05', '2026-03-05', '2026-04-05', '2026-05-05', '2026-06-05', '2026-07-05', '2026-08-05', '2026-09-05', '2026-10-05', '2026-11-05', '2026-12-05'], frequency: 'Månedlig', estimatedMinutes: 45, requiredData: ['Lønn og ytelser', 'Arbeidsforhold', 'Forskuddstrekk'], attachments: [], sourceLinks: ['source-a-melding', 'source-oppgaveregisteret'], status: 'in_progress', submissionMode: 'system', completionSource: 'rule', automaticCompletionPolicy: 'after_deadline', trigger: 'periodic', registerId: 'A-MELDING-01'
  },
  {
    id: 'obl-mva-termin-4', name: 'Mva-melding – termin 4', description: 'Rapporter utgående og inngående merverdiavgift for mai og juni.', conceptLinks: [{ label: 'merverdiavgift', query: 'merverdiavgift' }], detailInfo: { targetAudience: 'Virksomheter som er registrert i Merverdiavgiftsregisteret.', usageContexts: ['Periodisk rapportering'], usageNotes: ['Mva-meldingen oppsummerer utgående og inngående merverdiavgift for en termin.'], dataSources: ['Salg med mva', 'Kjøp med mva', 'Kontospesifikasjon'] }, officialStatus: 'OFFICIAL', responsibleAgency: 'Skatteetaten', legalBasis: 'Merverdiavgiftsloven kap. 15', targetCriteria: ['AS', 'mva-registrert'], reportingWindowStart: '2026-08-01', reportingWindowEnd: '2026-09-10', deadline: '2026-09-10', frequency: 'Seks ganger per år', estimatedMinutes: 60, requiredData: ['Salg med mva', 'Kjøp med mva', 'Kontospesifikasjon'], attachments: ['Eventuell dokumentasjon ved korrigering'], sourceLinks: ['source-mva', 'source-oppgaveregisteret'], status: 'in_progress', trigger: 'periodic', registerId: 'MVA-TERM-04'
  },
  {
    id: 'obl-aarsregnskap', name: 'Årsregnskap til Regnskapsregisteret', description: 'Send inn årsregnskap, årsberetning og revisjonsberetning der det kreves.', conceptLinks: [{ label: 'årsregnskap', query: 'årsregnskap' }], detailInfo: { targetAudience: 'Regnskapspliktige virksomheter.', usageContexts: ['Årlig rapportering'], usageNotes: ['Årsregnskapet gir en samlet oversikt over virksomhetens økonomiske stilling og utvikling.'], dataSources: ['Resultatregnskap', 'Balanse', 'Noter'] }, officialStatus: 'OFFICIAL', responsibleAgency: 'Brønnøysundregistrene', legalBasis: 'Regnskapsloven § 8-2', targetCriteria: ['AS', 'regnskapspliktig'], reportingWindowStart: '2026-05-01', reportingWindowEnd: '2026-07-31', deadline: '2026-07-31', frequency: 'Årlig', estimatedMinutes: 120, requiredData: ['Resultatregnskap', 'Balanse', 'Noter'], attachments: ['Årsberetning ved krav', 'Revisjonsberetning ved krav'], sourceLinks: ['source-arsregnskap'], status: 'completed', trigger: 'periodic', registerId: 'BR-AR-001'
  },
  {
  ...
  {
    id: 'obl-hms-melding', name: 'Årlig HMS-gjennomgang', description: 'Dokumenter intern gjennomgang av HMS-arbeidet og handlingsplan.', conceptLinks: [{ label: 'HMS', query: 'HMS' }], detailInfo: { targetAudience: 'Virksomheter med arbeidsgiveransvar.', usageContexts: ['Årlig oppfølging'], usageNotes: ['Systematisk HMS-arbeid innebærer å kartlegge farer, vurdere risiko og følge opp tiltak.'], dataSources: ['Avvik', 'Risikovurdering', 'Tiltak'] }, officialStatus: 'OFFICIAL_GUIDANCE', responsibleAgency: 'Arbeidstilsynet', legalBasis: 'Internkontrollforskriften § 5', targetCriteria: ['arbeidsgiveransvar'], reportingWindowStart: '2026-10-01', reportingWindowEnd: '2026-12-15', deadline: '2026-12-15', frequency: 'Årlig', estimatedMinutes: 90, requiredData: ['Avvik', 'Risikovurdering', 'Tiltak'], attachments: ['Handlingsplan'], sourceLinks: ['source-feriepenger'], status: 'not_started', trigger: 'periodic'
  },
  {
