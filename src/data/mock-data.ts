...
export const mockObligations: Obligation[] = [
  ...
  {
    id: 'obl-hms-melding', name: 'Årlig HMS-gjennomgang', description: 'Dokumenter intern gjennomgang av HMS-arbeidet og handlingsplan.', conceptLinks: [{ label: 'HMS', query: 'HMS' }], officialStatus: 'OFFICIAL_GUIDANCE', responsibleAgency: 'Arbeidstilsynet', legalBasis: 'Internkontrollforskriften § 5', targetCriteria: ['arbeidsgiveransvar'], reportingWindowStart: '2026-10-01', reportingWindowEnd: '2026-12-15', deadline: '2026-12-15', frequency: 'Årlig', estimatedMinutes: 90, requiredData: ['Avvik', 'Risikovurdering', 'Tiltak'], attachments: ['Handlingsplan'], sourceLinks: ['source-feriepenger'], status: 'not_started', trigger: 'periodic'
  },
  {
