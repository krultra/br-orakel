...
- **Årshjul og arbeidsliste:** Se rapporteringsplikter i et rullerende årshjul eller som liste. Brukeren kan aktivere oppgaver, følge frister, håndtere gjentakelser, sette enkel status, legge til egne opplysninger og kommentarer, dempe eller skjule det som ikke er relevant, og bare legge oppgaver i arbeidslisten når de skal jobbes aktivt med.
- **Gjenbruk fra år til år:** Status, lokale frister og erfaringer gjør at virksomheten kan planlegge neste rapporteringsår bedre. Metrikker og årshjul gir et samlet bilde av forventet arbeidsomfang.
...
- **Hjelp til å holde oversikt over offentlig støtte:** Se registrerte støttetildelinger knyttet til virksomheten. En tidligere tildeling kan brukes som signal til å opprette en lokal oppgave om å undersøke eller søke støtte på nytt.
...
ORaKeL gjør det mulig å gå fra enkeltstående registeroppslag til en samlet arbeidsflate. Virksomhetens organisasjonsform, næringskoder og arbeidsgiverforhold brukes som grunnlag for å finne relevante oppgaver i Oppgaveregisteret. Frister og rapporteringsformer kan deretter vises sammen med oppgaver virksomheten selv velger å følge opp. Støttehistorikk kan gi et signal om gjentagende søknadsprosesser: virksomheten kan legge en lokal søknadsoppgave med frist og årlig gjentakelse i både arbeidsliste og årshjul. Egne opplysninger, kommentarer, demping og skjuling gjør oversikten relevant for akkurat denne virksomheten.

Losen får virksomhetskonteksten som allerede er tilgjengelig i ORaKeL, blant annet organisasjonsform, næringskoder, arbeidsgiverforhold, valgte oppgaver, frister og relevante kilder. Det gjør svarene mer treffsikre enn et generelt spørsmål til en åpen AI-tjeneste som ChatGPT, samtidig som svaret fortsatt er veiledende. Støttedata gir ekstra kontekst, mens losen gjør informasjonen søkbar og forståelig på tvers av kildene.
...
- Virksomhetens egne uttrekk fra lønn, regnskap eller administrasjonssystemer som CSV, JSON eller regneark. Slike opplysninger skal merkes som brukerleverte og holdes adskilt fra registerdata, slik at virksomheten kan gjenbruke egne data i kommende rapporteringsår.
...
Åpne **https://demo.krultra.no** og velg **Opprett ny virksomhetsbruker**. Lag et valgfritt brukernavn, visningsnavn og et enkelt demo-passord. I topplinjen velger dere virksomhet ved å søke på navn eller organisasjonsnummer. For en komplett og forutsigbar demo kan dere søke etter **Fjordgløtt Mat og Handel AS** eller skrive **999999999**. Juryen kan også søke etter en virkelig virksomhet de kjenner, og få opp reelle virksomhetsdata fra Brønnøysundregistrenes åpne API-er.

Utforsk deretter årshjulet og arbeidslisten, åpne en oppgave og se frist, status, nødvendige data og kilder. Prøv gjerne Hendelser, Tilsyn og **Hjelp til å holde oversikt over offentlig støtte**. I støtteoversikten kan dere se registrerte tildelinger og lage en lokal, gjentagende oppfølging for å undersøke eller søke støtte på nytt. Åpne Losen, still et spørsmål om virksomheten og kontroller kildehenvisningene og usikkerheten i svaret. Svarhistorikken ligger tilgjengelig for brukeren.
